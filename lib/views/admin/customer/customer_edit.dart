...
class CustomerEdit extends StatefulWidget {
  ...
  CustomerEdit({required this.customerId, required this.customerData});
...
class _CustomerEditState extends State<CustomerEdit> {
  ...
  void _updateCustomer() async {
    ...
    Map<String, dynamic> updatedData = {
      ...
      "address_customer": _addressController.text,
    ...
    try {
      CustomerFsMethods().updateCustomer(widget.customerId, updatedData);
